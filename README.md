...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->158 banks across 24 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **158 banks & services** across **24 countries** with **multi-currency** capabilities:
...
### 🇪🇬 Egypt — EGP E£ (3)
**Arab Bank**, **CIB Egypt**, **National Bank of Egypt**

### 🇸🇻 El Salvador — USD $ (3)
**Banco Agricola**, **Banco Cuscatlan**, **Banco Promerica**

### 🇪🇺 Eurozone — EUR € (2)
**BPCE**, **Sparkasse Rhein-Maas**

### 🇰🇪 Kenya — KES Ksh (2)
**M-PESA**, **Standard Chartered Bank Kenya**
